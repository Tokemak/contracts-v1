...
const main = async () => {
	...
	const TTOKE_ADDRESS = getContractAddress(Environment.GOERLI, Contract.TOKE_POOL); //Goerli
	...
	//const balanceTrackerAddress = getContractAddress(Environment.MAINNET, Contract.BALANCE_TRACKER); //V2 Mainnet
	const balanceTrackerAddress = getContractAddress(Environment.GOERLI, Contract.BALANCE_TRACKER); //V2 Goerli
