...
const getConfig = (
	...
	return {
		managerAddress: getContractAddress(env, Contract.MANAGER),
		proxyAdmin: getContractAddress(env, Contract.PROXY_ADMIN),
		poolImplementation: getContractAddress(env, Contract.POOL_IMPLEMENTATION),
		devCoordinatorMultisig: getContractAddress(env, Contract.DEV_COORDINATOR_MULTISIG),
		underlyer,
		symbol,
		name,
		skipVerify,
