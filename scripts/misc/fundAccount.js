...
const { getContractAddress, Environment, Contract, getWhaleAddress } = require("utils/config");
...
async function main() {
	...
	const run = async () => {
		await fundUSDC(getWhaleAddress(Environment.MAINNET, Contract.USDC), "100000000");
		await fundWETH(getWhaleAddress(Environment.MAINNET, Contract.WETH), "1000000");
