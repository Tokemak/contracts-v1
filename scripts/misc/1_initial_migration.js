...
async function main() {
	...
	const uniswapRouterAddress = getContractAddress(Environment.MAINNET, Contract.UNI_ROUTER);
	const sushiswapRouterAddress = getContractAddress(Environment.MAINNET, Contract.SUSHI_ROUTER);
	const initialPools = [
		{
