...
async function main() {
	...
	const wethGenesisPool = await upgrades.deployProxy(ethPoolFactory, [
		getContractAddress(Environment.GOERLI, Contract.MANAGER),
		getContractAddress(Environment.GOERLI, Contract.ADDRESS_REGISTRY),
		"TokemakWethPool",
		"tWETH",
	]);
	...
	//   getContractAddress(Environment.Goerli, "Toke"),
	//   managerContract.address,
	//   "TokemakTokePool",
	//   "tToke",
	// ]);
