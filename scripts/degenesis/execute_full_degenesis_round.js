...
const { Contract, getContractAddress, Environment, getWhaleAddress } = require("utils/config");
...
const USDC_WHALE_ADDRESS = getWhaleAddress(Environment.MAINNET, Contract.USDC);
...
async function main() {
	...
	// const tokePoolAddress = getContractAddress(Environment.MAINNET, Contract.TOKE_POOL);
	// const sushiPoolAddress = getContractAddress(Environment.MAINNET, Contract.SUSHI_POOL);
	// const uniPoolAddress = getContractAddress(Environment.MAINNET, Contract.UNI_POOL);
	...
	//   params: [getContractAddress(Environment.MAINNET, Contract.PROXY_ADMIN)],
	// });
	// const proxyAdmin = await ethers.getSigner(
	//   getContractAddress(Environment.MAINNET, Contract.PROXY_ADMIN)
	// );
	...
	await network.provider.request({
		method: "hardhat_impersonateAccount",
		params: [getContractAddress(Environment.MAINNET, Contract.DEV_COORDINATOR_MULTISIG)],
	});
	const coordinator = await ethers.getSigner(
		getContractAddress(Environment.MAINNET, Contract.DEV_COORDINATOR_MULTISIG)
	);
