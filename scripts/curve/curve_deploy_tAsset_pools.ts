...
const main = async () => {
	...
	const pools: {
		...
		//   underlyer: getContractAddress(Environment.MAINNET, Contract.FXS),
		//   assetName: "FXS",
		// },
		// {
		//   //ALCX
		...
		//   underlyer: getContractAddress(Environment.MAINNET, Contract.ALCX),
		//   assetName: "ALCX",
		// },
		// {
		//   //SUSHI
		...
		//   underlyer: getContractAddress(Environment.MAINNET, Contract.SUSHI),
		//   assetName: "SUSHI",
		// },
		// {
		//   //FOX
		...
		//   underlyer: getContractAddress(Environment.MAINNET, Contract.FOX),
		//   assetName: "FOX",
		// },
		// {
		//   //TCR
		...
		//   underlyer: getContractAddress(Environment.MAINNET, Contract.TCR),
		//   assetName: "TCR",
		// },
		// {
		//   //APW
	...
	const poolFactory = await ethers.getContractAt(
		CurvePoolFactoryAbi,
		getContractAddress(Environment.MAINNET, Contract.CURVE_POOL_FACTORY)
	);
