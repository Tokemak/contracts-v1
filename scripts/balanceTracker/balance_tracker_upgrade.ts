...
async function main() {
	const PROXY_ADMIN_ADDRESS = getContractAddress(ENV, Contract.PROXY_ADMIN_POLYGON);
	const BALANCE_TRACKER = getContractAddress(ENV, Contract.BALANCE_TRACKER);
	const EVENT_PROXY = getContractAddress(ENV, Contract.EVENT_PROXY);
