...
const { getPrivateHardhatSignerKey, getPrivateHardhatSignerAddress } = require("utils/common");

// HARDHAT DEFAULT MNEMONIC
const SIGNER = getPrivateHardhatSignerAddress(0);
const ROTATED_SIGNER = getPrivateHardhatSignerAddress(1);
const SIGNER_KEY = getPrivateHardhatSignerKey(0);
const ROTATED_SIGNER_KEY = getPrivateHardhatSignerKey(1);
