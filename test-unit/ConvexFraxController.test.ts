...
import { getContractAddress as getAddress, Environment, Contract } from "utils/config";
...
const curveTokenAddress = getAddress(Environment.MAINNET, Contract.CRVFRAX);
...
const crv = getAddress(Environment.MAINNET, Contract.CURVE_TOKEN);
const cvx = getAddress(Environment.MAINNET, Contract.CONVEX_TOKEN);
const fxs = getAddress(Environment.MAINNET, Contract.FXS);
