...
const CURVE_TOKEN = getAddress(Environment.MAINNET, Contract.CURVE_TOKEN);
const CONVEX_TOKEN = getAddress(Environment.MAINNET, Contract.CONVEX_TOKEN);

const CURVE_3_POOL_LP_TOKEN = getAddress(Environment.MAINNET, Contract.CURVE_3_POOL_LP);
const CURVE_3_POOL_WHALE = getWhaleAddress(Environment.MAINNET, Contract.CURVE_3_POOL_LP);
const CURVE_3_POOL_TRANSFER_AMT = ethers.utils.parseEther("1000000");

const CONVEX_BOOSTER = getAddress(Environment.MAINNET, Contract.CONVEX_BOOSTER);
