...
import { Contract, Environment, getContractAddress as getAddress } from "utils/config";
import {
	IStableSwapPoolETH,
	CurveControllerETH,
	TestnetToken,
...
describe("Test Curve ETH Controller", () => {
	const CURVE_ADDRESS_PROVIDER_ADDRESS = getAddress(Environment.MAINNET, Contract.THIRDPARTY_CURVE_ADDRESS_PROVIDER);
	const CURVE_FACTORY_ADDRESS = getAddress(Environment.MAINNET, Contract.CURVE_POOL_FACTORY);
	const ETH_REGISTRY_ADDRESS = getAddress(Environment.MAINNET, Contract.ETH_REGISTRY);
