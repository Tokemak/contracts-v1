...
const token2weth = getAddress(Environment.MAINNET, Contract.WETH);

describe("Test Sushiswap Controller V1", () => {
	...
	const MASTERCHEF_V1 = getAddress(Environment.MAINNET, Contract.MASTERCHEF_V1);
